...
#                      are essentially the length constraints on the bars.
toolbox.register("attr_bool", random.uniform, 0.000001, 3.1)
...
# and the torque calculated from the evolved bar lengths
def evaluateTorque(individual):

    barLengths = {}
    barLengths['a'] = individual[0]
    barLengths['b'] = individual[1]
    barLengths['c'] = individual[2]
    barLengths['d'] = individual[3]
...
toolbox.register("evaluate", evaluateTorque)
