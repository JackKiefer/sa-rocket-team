...
plt.plot(theta, origTensionMoments, 'g', label='Original moment due to tension')
...
blue_line  = mlines.Line2D([],[],color='b',label='Optimized moment due to tension')
green_line = mlines.Line2D([],[],color='g',label='Original moment due to tension')
